...
#define FILESYSTEM_SIGNATUR					0x7E38CF10
// 클러스트의 크기(섹터 수), 4KB
...
{
	// 자료 구조의 타입 설정, 파일 핸들이나 디렉터리 핸들, 또는 빈 핸들 타입 지정 가능 
	BYTE bType;
