...
void kInitializePIC(void)
{
	...
	// ICW2 (포트0xA1), 인터럽트 벡터(0x20+8)
	kOutPortByte(PIC_SLAVE_PORT2,PIC_IRQSTARTVECTOR+8);

	// ICW3 (포트0xA1), 마스터 PIC 컨트롤러에 연결된 위치(정수로 표현)
