...
kSwitchAndExecute64bitKernel:
	;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
	; CR4 컨트롤 레지스터의 PAE 비트와 OSXMMEXCPT 비트, OXFXSR 비트를 1로 설정  
	;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
	mov eax, cr4				; CR4 컨트롤 레지스터의 값을 EAX 레지스터에 저장
	or eax, 0x620				; PAE 비트(비트5)와 OSXMMEXCPT 비트(비트10), OSFXSR 비트(비트9)를 모두 1로 설정 
	...
	;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
	; CR0 컨트롤 레지스터를 NW 비트(비트29)=0 CD 비트(비트 30)=0 PG 비트(비트31)=1로 설정하여 캐시 기능과 페이징 기능을 활성화 
	; TS 비트(비트3) =1, EM 비트(비트2) =0, MP 비트(비트1) =1로 설정하여 FPU를 활성화 
	;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
	mov eax, cr0				; EAX 레지스터에 CR0 컨트롤 레지스터를 저장
	or eax, 0xE000000E			; NW 비트,CD 비트,PG 비트,TS 비트,EM 비트,MP 비트을  모두 1로 설정
	xor eax, 0x60000004			; NW 비트 와 CD 비트,Em 비트를  XOR하여 0으로 설정
	mov cr0, eax				; NW 비트 = 0, CD 비트 = 0, PG 비트 = 1, TS 비트 = 1, EM 비트 = 0, MP 비트 = 1로 설정한 값을 다시 CR0 컨트롤 레지스터에 저장
