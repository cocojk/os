...
STARTGRAPHICMODE:	db	0x00		; 그래픽 모드로 시작하는지 여부 
...
START:
	...
	mov sp, 0xFFFC					; SP 레지스터의 어드레스를 0xFFFC로 설정
	mov bp, 0xFFFC  				; BP 레지스터의 어드레스를 0xFFFC로 설정
...
.SCREENCLEARLOOP:					; 화면을 지우는 루프
	...
	push MESSAGE1					; 출력 메시지의 어드레스를 스택에 삽입 
	...
	push IMAGELOADINGMESSAGE		; 출력 메시지의 어드레스를 스택에 삽입 
...
READDISK:							; 디스크를 리셋하는 코드의 시작
	;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
	; BIOS Reset Fuction 호출 
	;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
...
READDATA:							; 디스크를 읽는 코드의 시작
	...
	mov byte[SECTORNUMBER], al		; 증가 시킨 섹터 번호는 SECTORNUMBER에 다시 설정
	cmp al, 19						; 증가 시킨 섹터 번호를 19와 비교
	...
	; 만약 헤드가 1->0로 바뀌었으면 양쪽 헤드를 모두 읽은 것이므로 아래로 이동하여 트랙 번호를 1증가
...
READEND:
	...
	mov di, 0x00					; 0x00을 설정하여 0x07E0:0x0000(0x7E00) 어드레스에 모드 정보 블록을 저장 
	...
	mov bx, 0x4117						; 10244*768 해상도에 16비트(R(5):G(6):B(5)) 색을 사용하는 
										; 선형 프레임 버퍼 모드 지정 
										; VBE 모드 번호(Bit 0~8) = 0x117, 버퍼 모드(비트 14)= 1(선형 프레임 버퍼 모드)
	int 0x10							; 인터럽트 서비스 수행 
	cmp ax, 0x004F						; 에러가 발생했다면 VBEERROR로 이동 
	jne VBEERROR

	; 그래픽 모드로 전환되었다면 보호 모드 커널로 읻ㅇ 
...
.MESSAGELOOP:						; 메시지를 출력하는 루프
	mov cl,byte[si]					; MESSAGE1의 어드레스를 SI레지스터 값만큼 더한 위치의 문자를 CL 레지스터에 복사 
